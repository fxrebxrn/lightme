TEXTS = {
    'uk': {
        ...
        'status_next_off': '<tg-emoji emoji-id="5891100675042974129">📅</tg-emoji> Наступна подія: <tg-emoji emoji-id="5330017696660599813">🔲</tg-emoji> Відключення о {off_time} до {on_time}.',
        'status_next_on': '<tg-emoji emoji-id="5891100675042974129">📅</tg-emoji> Наступна подія: <tg-emoji emoji-id="5330396907913098490">🟩</tg-emoji> Включення о {on_time} до {off_time}.',
    ...
    'ru': {
        ...
        'status_to_on': '<tg-emoji emoji-id="5258258882022612173">⏲</tg-emoji> До включения: {duration} (в {time})',
        'status_next_off': '<tg-emoji emoji-id="5891100675042974129">📅</tg-emoji> Следующее событие: 🔴 Отключение в {off_time} до {on_time}.',
        'status_next_on': '<tg-emoji emoji-id="5891100675042974129">📅</tg-emoji> Следующее событие: 🟢 Включение в {on_time} до {off_time}.',
